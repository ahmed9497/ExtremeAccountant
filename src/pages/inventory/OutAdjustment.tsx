...
const OutAdjustment = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl tracking-wider mb-6">Add Stock Adjustment Out</h1>
      <Card>
        <h1 className="text-xl mb-3 font-bold">Details</h1>
        <div>
          <Row gutter={20}>
            <Col span={8}>
              <div className="mb-3">
                <label className="text-[14px] block font-normal">COA</label>

                <Input placeholder="COA" disabled value={"Stock"} />
              </div>
            </Col>
            <Col span={8}>
              <div className="mb-3">
