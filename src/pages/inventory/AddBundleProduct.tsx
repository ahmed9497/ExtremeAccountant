...
const AddBundleProduct = () => {
 ...
 <h1 className="text-3xl tracking-wider mb-6">Add Bundle Product</h1>
      <Card>
           ...
           <div className="mb-3">
            ...
            <Col span={8}>
              ...
              <div>
                ...
                <div className=" h-10 flex justify-start items-center px-2 rounded-sm">
                  <Checkbox> Print Details</Checkbox>
                </div>
              </div>
            </Col>
          </Row>
