...
import { CheckBoxField, InputBox, SelectBox, TextAreaBox } from "@components/formfields";
...
const AddNonStockProduct = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl tracking-wider mb-6">Add Non Stock Product</h1>
...
export default AddNonStockProduct;
