...
const AddCreditPaymentPurchase = () => {
...
const columns: TableColumnsType<DataType> = [
  ...
  return (
    <div>
      <h1 className="text-xl mb-3 font-bold">Add Credit Note Payment</h1>
      <Card>
        <div>
          <Row gutter={20}>
            <Col span={8}>
        ...
        <div>
          <h1 className="text-xl mb-3 font-bold"> Outstanding Credits</h1>
           <Table
...
export default AddCreditPaymentPurchase;
