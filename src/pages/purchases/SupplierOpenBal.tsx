...
const columns: TableColumnsType<DataType> = [
  ...
  },
  {
    ...
    render: () => (
      <Space size="small">
        <div className="bg-[#F7F7F7] p-1 cursor-pointer rounded" onClick={()=>navigate('/dashboard/purchases/supplier-payment')}>
          <GiTakeMyMoney size={20} color="green" />
        </div>
        <div className="bg-[#F7F7F7] p-1 cursor-pointer rounded">
          <FaFileInvoice size={15} color="violet"  onClick={()=>navigate('/dashboard/purchases/bills')}/>
        </div>
  ...
  return (
    <Fragment>
      ...
      <div className="mt-6 flex justify-between">
        <h1 className="text-3xl tracking-wider mb-6">Supplier Opening Balances</h1>
        {/* <div className="flex gap-3">
          ...
          <Button
            ...
            onClick={() => {
              navigate('/dashboard/sales/Supplier-open-Bal')
            }}
            // onClick={() => {
...
export default SupplierOpenBal;
