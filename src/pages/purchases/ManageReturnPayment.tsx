...
const columns: TableColumnsType<DataType> = [
  ...
  return (
    <div>
      <h1 className="text-xl mb-3 font-bold">Manage Return</h1>
      <Card>
        <div>
          <Row gutter={20}>
            <Col span={8}>
        ...
        <div>
          <h1 className="text-xl mb-3 font-bold">Unallocated Receipts</h1>
           <Table
...
export default ManageReturnPayment;
