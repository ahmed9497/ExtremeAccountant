...
import { banks, modes } from "@utils/data";
...
const BatchCreditPaymentPurchase = ({
  ...
  return (
    <div>
      <h1 className="text-xl mb-3 font-bold">Batch Credit Note Payment</h1>
      <div>
...
export default BatchCreditPaymentPurchase;
