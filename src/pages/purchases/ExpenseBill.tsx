...
const ExpenseBill = () => {
  ...
  return (
    <div>
          <h1 className="text-3xl tracking-wider mb-6">Add Supplier Bill</h1>
      <Card>
        ...
        <div>
          <Row gutter={20}>
            ...
            <Col span={8}>
             <div className="mb-3">
                <label className="text-[14px] block font-normal">Bill No.</label>
      ...
      <Card>
        <h1 className="text-xl mb-3 font-bold">Add Payment</h1>
        <Row gutter={20}>
          <Col span={4}>
            <label className="text-[14px] block font-normal">Date</label>
