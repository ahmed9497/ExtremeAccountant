...
const columnsBills: TableColumnsType<DataType> = [
  ...
  return (
    <div>
      <h1 className="text-xl mb-3 font-bold">Combined Account Offset</h1>
      <Card>
        <div>
          <Row gutter={20}>
            <Col span={8}>
        ...
        <div>
          <h1 className="text-xl mb-3 font-bold"> Outstanding Invoices</h1>
           <Table
        ...
        <div className="my-3">
          <h1 className="text-xl mb-3 font-bold"> Outstanding Bills</h1>
           <Table
...
export default BatchCombinePayment;
