  ...
  return (
    <Fragment>
      ...
      <div className="mt-6 flex justify-between">
        <h1 className="text-3xl tracking-wider mb-6">Receipts</h1>
        <div className="flex gap-3">
          <Select
            ...
            options={[
              { value: "sale-invoice-receipt", label: "Receipt(SR)" },
              { value: "credit-payment", label: "Payment(SCP)" },
              { value: "manage-return", label: "Return Receipt (RSR)" },
              { value: "manage-return", label: "Return Payment(RSCP)" },
            ]}
          />
          <Select
            defaultValue="Batch"
            ...
            options={[
              { value: "batch-sale-receipt", label: "Receipt(SR)" },
