...
const AddCreditInvoice = () => {
  ...
  return (
    <div>
        <h1 className="text-xl mb-3 font-bold">Add Credit Note</h1>

      <Card>
        <h1 className="text-xl mb-3 font-bold">Customer Details</h1>
        <div>
          <Row gutter={20}>
            <Col span={8}>
              <div className="mb-3">
            ...
            <Col span={8}>
              ...
              <div>
                <label className="text-[14px] block font-normal">Doc No</label>
      ...
      <Card>
        <h1 className="text-xl mb-3 font-bold">Add Receipt</h1>
        <Row gutter={20}>
          <Col span={4}>
            <label className="text-[14px] block font-normal">Date</label>

            <DatePicker placeholder="Date" className="h-10 w-full rounded-sm" />
          </Col>
          <Col span={5}>
          ...
          <Col span={5}>
            <label className="text-[14px] block font-normal">Mode</label>
          ...
          <Col span={5}>
            <label className="text-[14px] block font-normal">Ref No.</label>
...
export default AddCreditInvoice;
